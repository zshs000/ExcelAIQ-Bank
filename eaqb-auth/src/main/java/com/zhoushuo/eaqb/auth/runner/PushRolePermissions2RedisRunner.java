package com.zhoushuo.eaqb.auth.runner;

import cn.hutool.core.collection.CollUtil;
import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.zhoushuo.eaqb.auth.constant.RedisKeyConstants;
import com.zhoushuo.eaqb.auth.domain.dataobject.PermissionDO;
import com.zhoushuo.eaqb.auth.domain.dataobject.RoleDO;
import com.zhoushuo.eaqb.auth.domain.dataobject.RolePermissionDO;
import com.zhoushuo.eaqb.auth.domain.mapper.PermissionDOMapper;
import com.zhoushuo.eaqb.auth.domain.mapper.RoleDOMapper;
import com.zhoushuo.eaqb.auth.domain.mapper.RolePermissionDOMapper;
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            ...
            if (CollUtil.isNotEmpty(roleDOS)) {
                ...
                log.info("==> 获取所有 APP 端所有被启用的权限: {}", permissionDOS);
                // 权限 ID - 权限 DO
