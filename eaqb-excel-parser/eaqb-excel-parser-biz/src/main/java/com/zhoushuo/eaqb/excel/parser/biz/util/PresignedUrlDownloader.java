...
public class PresignedUrlDownloader {
     ...
     */
    public static DownloadedExcelResource downloadWithResponse(String presignedUrl) throws IOException {
        HttpGet httpGet = new HttpGet(presignedUrl);
        ...
        return new DownloadedExcelResource(inputStream, response);
    }
